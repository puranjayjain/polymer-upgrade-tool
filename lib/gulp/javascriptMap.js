...
module.exports = [
  ...
  // serialize( => _serializeValue( 
  {
    'search': / serialize\(/igm,
    'replacement': ' _serializeValue(',
    'type': 'Replace'
  },
  // deserialize( => _deserializeValue( 
  {
    'search': / deserialize\(/igm,
    'replacement': ' _deserializeValue(',
    'type': 'Replace'
  },
  // Polymer.dom(this).observeNodes(this._nodesChanged) => new Polymer.FlattenedNodesObserver(this._nodesChanged)
  {
    'search': /(Polymer\.dom\(this\)\.observeNodes\()(.*)(\))/igm,
    'replacement': 'new Polymer.FlattenedNodesObserver($2)',
    'type': 'Replace'
  }
];
